...
import { Users, X, BadgeCheck, Settings, Trash2 } from "lucide-react";
...
export default function PartnerManagementModal({ isOpen, onClose, registeredPartners, onToggleVerificado, onChangePlano, onRename, onDelete }) {
